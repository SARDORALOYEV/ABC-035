        ...
        <div className="flex items-center justify-between h-8 max-w-7xl mx-auto">
          <div className="flex items-center gap-3 sm:gap-5 overflow-hidden">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] sm:text-[13px] text-gray-400 truncate">Москва, 38КМ МКАД, 6Бс1</span>
            </div>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <span className="text-[11px] sm:text-[13px] text-slate-700 underline">Whatsapp</span>
          </div>
        </div>
      </div>
